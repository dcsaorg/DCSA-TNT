...
public class EventSubscriptionsIT {
  ...
  public void testUpdateSecret() {
    ...
    given()
      ...
      .put("/v3/event-subscriptions/" + created.getSubscriptionID() + "/secret")
      .then()
      .assertThat()
      .statusCode(HttpStatus.OK.value())
    ;
    ...
    given()
      .contentType("application/json")
      .get("/v3/unofficial/event-subscriptions-dao/" + created.getSubscriptionID())
      .then()
      .assertThat()
      .statusCode(HttpStatus.OK.value())
      .contentType(ContentType.JSON)
  ...
  public void testDelete() {
    ...
    given()
      .contentType("application/json")
      .delete("/v3/event-subscriptions/" + created.getSubscriptionID())
      .then()
      .assertThat()
    ...
    given()
      .contentType("application/json")
      .get("/v3/event-subscriptions/" + created.getSubscriptionID())
      .then()
      .assertThat()
