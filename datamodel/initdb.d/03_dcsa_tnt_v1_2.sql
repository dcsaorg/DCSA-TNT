...
DROP TABLE IF EXISTS dcsa_tnt_v1_2.event CASCADE;
CREATE TABLE dcsa_tnt_v1_2.event (
...
DROP TABLE IF EXISTS dcsa_tnt_v1_2.equipment_event CASCADE;
CREATE TABLE dcsa_tnt_v1_2.equipment_event (
...
INHERITS (dcsa_tnt_v1_2.event);


DROP TABLE IF EXISTS dcsa_tnt_v1_2.shipment_event CASCADE;
CREATE TABLE dcsa_tnt_v1_2.shipment_event (
...
DROP TABLE IF EXISTS dcsa_tnt_v1_2.transport_event CASCADE;
CREATE TABLE dcsa_tnt_v1_2.transport_event (
...
DROP TABLE IF EXISTS dcsa_tnt_v1_2.transport_equipment_event CASCADE;
CREATE TABLE dcsa_tnt_v1_2.transport_equipment_event (
    equipment_reference text NOT NULL,
    facility_type_code text NOT NULL,
    un_location_code text NOT NULL,
    facility_code text NOT NULL,
...
DROP TABLE IF EXISTS dcsa_tnt_v1_2.event_subscription CASCADE;
CREATE TABLE dcsa_tnt_v1_2.event_subscription (
...
-- Helper table in order to filter Events on blnumber
DROP TABLE IF EXISTS dcsa_tnt_v1_2.shipment CASCADE;
CREATE TABLE dcsa_tnt_v1_2.shipment (
    ...
    bill_of_lading_number varchar(20), -- Transport Document ID is an identifier that links to a shipment. Bill of lading is the legal document issued to the customer which confirms the carrier's receipt of the cargo from the customer acknowledging goods being shipped and specifying the terms of delivery.
...
DROP VIEW IF EXISTS dcsa_tnt_v1_2.aggregated_events CASCADE;
CREATE VIEW dcsa_tnt_v1_2.aggregated_events AS
 SELECT transport_event.event_id,
   ...
   FROM dcsa_tnt_v1_2.transport_event
UNION
 SELECT shipment_event.event_id,
   ...
   FROM dcsa_tnt_v1_2.shipment_event
UNION
 SELECT equipment_event.event_id,
    ...
    NULL::text AS transport_leg_reference,
    NULL::text AS mode_of_transport_code
   FROM dcsa_tnt_v1_2.equipment_event
UNION
 SELECT transport_equipment_event.event_id,
   ...
   FROM dcsa_tnt_v1_2.transport_equipment_event;
