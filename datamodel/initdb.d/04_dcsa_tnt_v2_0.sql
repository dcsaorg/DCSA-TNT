...
DROP TABLE IF EXISTS dcsa_tnt_v2_0.event CASCADE;
CREATE TABLE dcsa_tnt_v2_0.event (
...
DROP TABLE IF EXISTS dcsa_tnt_v2_0.equipment_event CASCADE;
CREATE TABLE dcsa_tnt_v2_0.equipment_event (
    equipment_reference varchar(15),
    empty_indicator_code text NOT NULL,
    transport_call_id uuid NOT NULL
) INHERITS (dcsa_tnt_v2_0.event);

DROP TABLE IF EXISTS dcsa_tnt_v2_0.shipment_event CASCADE;
CREATE TABLE dcsa_tnt_v2_0.shipment_event (
    shipment_id uuid NOT NULL,
    shipment_information_type_code varchar(3) NOT NULL
) INHERITS (dcsa_tnt_v2_0.event);

DROP TABLE IF EXISTS dcsa_tnt_v2_0.transport_event CASCADE;
CREATE TABLE dcsa_tnt_v2_0.transport_event (
    delay_reason_code varchar(3),
    vessel_schedule_change_remark varchar(250),
    transport_call_id uuid NOT NULL
) INHERITS (dcsa_tnt_v2_0.event);

DROP TABLE IF EXISTS dcsa_tnt_v2_0.event_subscription CASCADE;
CREATE TABLE dcsa_tnt_v2_0.event_subscription (
...
DROP VIEW IF EXISTS dcsa_tnt_v2_0.aggregated_events CASCADE;
CREATE VIEW dcsa_tnt_v2_0.aggregated_events AS
 SELECT transport_event.event_id,
   ...
   FROM dcsa_tnt_v2_0.transport_event
UNION
 SELECT shipment_event.event_id,
   ...
   FROM dcsa_tnt_v2_0.shipment_event
UNION
 SELECT equipment_event.event_id,
    ...
    NULL::UUID AS shipment_id
   FROM dcsa_tnt_v2_0.equipment_event;

--Helper table in order to filter Events on schedule_id
DROP TABLE IF EXISTS dcsa_tnt_v2_0.schedule CASCADE;
CREATE TABLE dcsa_tnt_v2_0.schedule (
    id uuid DEFAULT uuid_generate_v4() PRIMARY KEY,
...
DROP TABLE IF EXISTS dcsa_tnt_v2_0.transport_call CASCADE;
CREATE TABLE dcsa_tnt_v2_0.transport_call (
    id uuid DEFAULT uuid_generate_v4() PRIMARY KEY,
...
DROP TABLE IF EXISTS dcsa_tnt_v2_0.shipment CASCADE;
CREATE TABLE dcsa_tnt_v2_0.shipment (
    id uuid NOT NULL,
